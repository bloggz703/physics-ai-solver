        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Physics AI Solver</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/contact" className="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md">Contact</Link>
          </div>
